...
class MAML(Algorithm):
    ...
    def __init__(self, train_base_lr, base_lr, second_order, grad_clip=None, meta_batch_size=1, special=False, log_norm=False, random=False, var_updates=False, **kwargs):
